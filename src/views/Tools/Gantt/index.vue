...
import * as Highcharts from './highcharts-gantt.js'
        ...
        gantt.value = window.Highcharts.ganttChart('container', {
          ...
          xAxis: [
            {
              ...
              labels: {
                align: 'center',
                formatter: function () {
                  return `${dayjs(this.value).format('M月D')}  ${
                    WEEKS[dayjs(this.value).day()]
                  }`
                },
              },
            },
          ...
          tooltip: {
            formatter: function () {
              ...
              开始时间: ${dayjs(this.point.start).format(
                'YYYY-MM-DD HH:mm:ss'
              )}<br/>
              结束时间: ${dayjs(this.point.end).format(
                'YYYY-MM-DD HH:mm:ss'
              )}<br/>
              </div>`
            },
